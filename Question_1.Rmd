...
Based on these criteria, adjusted r-squared has the highest value in
Model 1 which it provides the best fir per predictor used. Model 1 has
...
p-values. Therefore, Model 1 which include Height and Sex as predictors,
...
-   Coefficient for Female(-1.816): On avg, the female is 1.816cm
    ...
    But this predictor is not statistically significant at th 10% level
...
-   Significant Predictors: When it's at 10% level of significance, only
    ...
    way below 0.1. The variables of sex are not significant at this
    level.
...
ggplot() + 
  ...
  geom_point(aes(x = fitted_values, y = residuals), color = "orange") +
